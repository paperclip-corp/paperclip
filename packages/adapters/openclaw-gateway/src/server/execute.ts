...
export async function execute(ctx: AdapterExecutionContext): Promise<AdapterExecutionResult> {
  ...
  // Note: paperclip payload is not sent to OpenClaw gateway as AgentParamsSchema
  // does not accept additionalProperties. The context is kept locally for logging.
